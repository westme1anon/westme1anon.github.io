...
export const siteConfig: SiteConfig = {
	...
	navbarTitle: {
		...
		icon: "assets/home/circlekumiko0.png",
	},

	bangumi: {
		userId: "963121", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/mobile-banner/tou_tu.png" //相对于/public
				
				
				
			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/tou_tu.png"
				  //相对于/public
	...
	font: {
		...
		cjkFont: {
			...
			fontWeight: "500",
			localFonts: ["Montserrat-VariableFont_wght.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
	...
	links: [
		...
		// 	children: [
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/westme1anon",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/403338362",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://steamcommunity.com/profiles/76561198904761814/",
		},
		{
			name: "bilibili",
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://soyo11.netlify.app/.netlify/functions/twikoo",
